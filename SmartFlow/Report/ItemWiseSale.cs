...
{
    public partial class ItemWiseSale: Form
    {
        ...
        private void ItemWiseSale_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailItemWiseSale detailItemWiseSale = new DetailItemWiseSale(dataInvoice, startDate, endDate);
                    detailItemWiseSale.MdiParent = Application.OpenForms["Dashboard"];
                    CommonFunction.DisposeOnClose(detailItemWiseSale);
                    detailItemWiseSale.Show();
                }
            }
        }
