...
{
    public partial class DetailItemWisePurchase: Form
    {
        private DataTable _datainvoice;
        private DateTime _startdate;
        private DateTime _enddate;
        public DetailItemWisePurchase(DataTable datainvoice, DateTime startdate, DateTime enddate)
        {
            InitializeComponent();
        ...
        private void DetailItemWisePurchase_Load(object sender, EventArgs e)
        {
