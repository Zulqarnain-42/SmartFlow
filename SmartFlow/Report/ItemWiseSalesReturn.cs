...
{
    public partial class ItemWiseSalesReturn: Form
    {
        private static string connectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        public ItemWiseSalesReturn()
        {
            InitializeComponent();
        }

        private void ItemWiseSalesReturn_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailItemWiseSaleReturn detailItemWiseSaleReturn = new DetailItemWiseSaleReturn(dataInvoice, startDate, endDate);
                    detailItemWiseSaleReturn.MdiParent = Application.OpenForms["Dashboard"];
                    CommonFunction.DisposeOnClose(detailItemWiseSaleReturn);
                    detailItemWiseSaleReturn.Show();
                }
            }
        }
    }
