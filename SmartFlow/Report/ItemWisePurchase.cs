...
{
    public partial class ItemWisePurchase: Form
    {
        ...
        private void ItemWisePurchase_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailItemWisePurchase detailItemWisePurchase = new DetailItemWisePurchase(dataInvoice, startDate, endDate);
                    detailItemWisePurchase.MdiParent = Application.OpenForms["Dashboard"];
                    CommonFunction.DisposeOnClose(detailItemWisePurchase);
                    detailItemWisePurchase.Show();
                }
            }
        }
    }
