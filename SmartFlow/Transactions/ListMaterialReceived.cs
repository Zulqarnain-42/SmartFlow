    ...
    public partial class ListMaterialReceived : Form
    {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailMaterialReceived detailMaterialReceived = new DetailMaterialReceived(dataInvoice, startDate, endDate);
                    detailMaterialReceived.MdiParent = Application.OpenForms["Dashboard"];
                    CommonFunction.DisposeOnClose(detailMaterialReceived);
                    detailMaterialReceived.Show();
                }
            }
        }
    }
