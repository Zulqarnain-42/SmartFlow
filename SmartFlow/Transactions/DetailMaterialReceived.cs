...
{
    public partial class DetailMaterialReceived : Form
    {
        private DataTable _invoiceData;
        private DateTime _startDate;
        private DateTime _endDate;

        public DetailMaterialReceived(DataTable invoiceData, DateTime startDate, DateTime endDate)
        {
            InitializeComponent();
        ...
        private void DetailMaterialReceived_Load(object sender, EventArgs e)
        {
