...
{
    public partial class DetailMaterialIssue : Form
    {
        private DataTable _invoiceData;
        private DateTime _startDate;
        private DateTime _endDate;

        public DetailMaterialIssue(DataTable invoiceData, DateTime startDate, DateTime endDate)
        {
            InitializeComponent();
        ...
        private void DetailMaterialIssue_Load(object sender, EventArgs e)
        {
        ...
        private async void dgvlistinvoices_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                if (dataInvoice.Rows.Count > 0)
                {
                    ...
                    {
                        MaterialIssueToParty materialIssueToParty = new MaterialIssueToParty(dataInvoice, dtInvoiceDetails);
