...
{
    public partial class ListReceipt : Form
    {
        ...
        private void ListReceipt_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailReceipt detailReceipt = new DetailReceipt(dataInvoice);
                    detailReceipt.MdiParent = Application.OpenForms["Dashboard"];
                    CommonFunction.DisposeOnClose(detailReceipt);
                    detailReceipt.Show();
                }
            }
