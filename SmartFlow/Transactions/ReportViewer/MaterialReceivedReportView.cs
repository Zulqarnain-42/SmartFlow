...
{
    public partial class MaterialReceivedReportView : Form
    {
        private string _invoiceNo = string.Empty;

        public MaterialReceivedReportView(string invoiceNo)
        {
            InitializeComponent();
            this._invoiceNo = invoiceNo;
        }

        private void MaterialReceivedReportView_Load(object sender, EventArgs e)
        {
        ...
        private void LoadCrystalReport(string invoiceNo)
        {
            try
            {
                ...
                string reportPath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"Transactions\ReportViewer\Reports\MaterialReceivedParty.rpt");
