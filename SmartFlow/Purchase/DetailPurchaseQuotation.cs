...
{
    public partial class DetailPurchaseQuotation : Form
    {
        private DataTable _dataInvoice;
        private DateTime _startDate;
        private DateTime _endDate;
        public DetailPurchaseQuotation(DataTable dataInvoice, DateTime startDate, DateTime endDate)
        {
            InitializeComponent();
        ...
        private void DetailPurchaseQuotation_Load(object sender, EventArgs e)
        {
        ...
        { 
            ...
            if (e.RowIndex >= 0)
            {
                ...
                if (dataInvoice.Rows.Count > 0)
                {
                    ...
                    {
                        PurchaseQuotationInvoice purchaseQuoteInvoice = new PurchaseQuotationInvoice(dataInvoice, dtInvoiceDetails);
                        purchaseQuoteInvoice.MdiParent = Application.OpenForms["Dashboard"];
                        CommonFunction.DisposeOnClose(purchaseQuoteInvoice);
                        purchaseQuoteInvoice.Show();
                    }
                }
                else
                {
        ...
        private void DetailPurchaseQuotation_KeyDown(object sender, KeyEventArgs e)
        {
