...
{
    public partial class DetailPurchaseReturn : Form
    {
        private DataTable _dataInvoice;
        private DateTime _startDate;
        private DateTime _endDate;
        public DetailPurchaseReturn(DataTable dataInvoice, DateTime startDate, DateTime endDate)
        {
            InitializeComponent();
        ...
        private void DetailPurchaseReturn_Load(object sender, EventArgs e)
        {
        ...
        private void DetailPurchaseReturn_KeyDown(object sender, KeyEventArgs e)
        {
