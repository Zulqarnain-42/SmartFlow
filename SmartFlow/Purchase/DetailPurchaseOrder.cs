...
{
    public partial class DetailPurchaseOrder : Form
    {
        private DataTable _dataInvoice;
        private DateTime _startDate;
        private DateTime _endDate;
        public DetailPurchaseOrder(DataTable dataInvoice, DateTime startDate, DateTime endDate)
        {
            InitializeComponent();
        ...
        private void DetailPurchaseOrder_Load(object sender, EventArgs e)
        {
        ...
        private void DetailPurchaseOrder_KeyDown(object sender, KeyEventArgs e)
        {
