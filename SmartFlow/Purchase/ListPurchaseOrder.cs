...
namespace SmartFlow.Purchase
{
    public partial class ListPurchaseOrder : Form
    {
        ...
        private void ListPurchaseOrder_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailPurchaseOrder listInvoiceDetail = new DetailPurchaseOrder(dataInvoice, startDate, endDate);
