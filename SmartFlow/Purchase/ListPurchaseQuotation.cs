...
{
    public partial class ListPurchaseQuotation : Form
    {
        private static string connectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;

        public ListPurchaseQuotation()
        {
            InitializeComponent();
        }

        private void ListPurchaseQuotation_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                command.Parameters.AddWithValue("@IsNewRecord", true); // assuming IsNewRecord is a boolean flag
                ...
                {
                    this.Close();
                    DetailPurchaseQuotation listInvoiceDetail = new DetailPurchaseQuotation(dataInvoice, startDate, endDate);
