...
{
    public partial class ListPurchaseReturn : Form
    {
        private static string connectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        public ListPurchaseReturn()
        {
            InitializeComponent();
        }

        private void ListPurchaseReturn_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailPurchaseReturn listInvoiceDetail = new DetailPurchaseReturn(dataInvoice, startDate, endDate);
