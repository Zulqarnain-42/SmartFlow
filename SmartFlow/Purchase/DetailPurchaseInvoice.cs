...
{
    public partial class DetailPurchaseInvoice : Form
    {
        private DataTable _invoiceData;
        private DateTime _startDate;
        private DateTime _endDate;
        public DetailPurchaseInvoice(DataTable invoiceData, DateTime startDate, DateTime endDate)
        {
            InitializeComponent();
        ...
        private void ListInvoiceDetail_Load(object sender, EventArgs e)
        {
        ...
        private void DetailPurchaseInvoice_KeyDown(object sender, KeyEventArgs e)
        {
