...
{
    public partial class DetailProformaInvoice : Form
    {
        private DataTable _invoiceData;
        private DateTime _startDate;
        private DateTime _endDate;
        public DetailProformaInvoice(DataTable invoiceData, DateTime startDate, DateTime endDate)
        {
            InitializeComponent();
        ...
        private void DetailProformaInvoice_Load(object sender, EventArgs e)
        {
        ...
        private async void dgvlistinvoices_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                if (dataInvoice.Rows.Count > 0)
                {
                    ...
                    {
                        PerformaInvoice proformaInvoice = new PerformaInvoice(dataInvoice, dtInvoiceDetails);
                        proformaInvoice.MdiParent = Application.OpenForms["Dashboard"];
                        CommonFunction.DisposeOnClose(proformaInvoice);
                        proformaInvoice.Show();
                    }
                }
                else
                {
        ...
        private void DetailProformaInvoice_KeyDown(object sender, KeyEventArgs e)
        {
