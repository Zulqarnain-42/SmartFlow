...
{
    public partial class DetailSaleQuotation : Form
    {
        private DataTable _invoiceData;
        private DateTime _startDate;
        private DateTime _endDate;
        public DetailSaleQuotation(DataTable invoiceData, DateTime startDate, DateTime endDate)
        {
            InitializeComponent();
        ...
        private void DetailSaleQuotation_Load(object sender, EventArgs e)
        {
        ...
        private void DetailSaleQuotation_KeyDown(object sender, KeyEventArgs e)
        {
