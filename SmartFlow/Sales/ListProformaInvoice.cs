...
{
    public partial class ListProformaInvoice : Form
    {
        private static string connectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;

        public ListProformaInvoice()
        {
            InitializeComponent();
        }

        private void ListProformaInvoice_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            // Now use parameterized SQL command
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailProformaInvoice listInvoiceDetail = new DetailProformaInvoice(dataInvoice, startDate, endDate);
