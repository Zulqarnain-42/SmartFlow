...
{
    public partial class DetailSaleInvoice : Form
    {
        private DataTable _invoiceData;
        private DateTime _startDate;
        private DateTime _endDate;
        public DetailSaleInvoice(DataTable invoiceData, DateTime startDate, DateTime endDate)
        {
            InitializeComponent();
        ...
        private void DetailSaleInvoice_Load(object sender, EventArgs e)
        {
        ...
        private void DetailSaleInvoice_KeyDown(object sender, KeyEventArgs e)
        {
