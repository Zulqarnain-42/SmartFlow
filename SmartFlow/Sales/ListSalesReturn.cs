...
{
    public partial class ListSalesReturn : Form
    {
        private static string connectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;

        public ListSalesReturn()
        {
            InitializeComponent();
        }

        private void ListSalesReturn_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailSaleReturn listInvoiceDetail = new DetailSaleReturn(dataInvoice, startDate, endDate);
