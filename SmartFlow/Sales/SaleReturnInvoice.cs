...
namespace SmartFlow
{
    public partial class SaleReturnInvoice : Form
    {
        ...
        {
            await CommonFunction.CalculateTotalVatColumnAsync(7,dgvsaleproducts, totalvattxtbox);
            await CommonFunction.CalculateTotalDiscountColumnAsync(8, dgvsaleproducts, totaldiscounttxtbox);
        ...
        private async void savebtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    bool resultdata = await DatabaseAccess.ExecuteQueryAsync(tableName, "INSERT", columnData);
        ...
        private async void WarehouseSelection_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                ...
                await CommonFunction.DisposeOnCloseAsync((WarehouseSelection)sender);
