...
{
    public partial class ProductListReportViewer : Form
    {
        private ReportDocument reportDocument;
        public ProductListReportViewer()
        {
            InitializeComponent();
        }
        private void ProductListReportViewer_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void ProductListReportViewer_FormClosing(object sender, FormClosingEventArgs e)
        {
            DisposeReport();
        }
