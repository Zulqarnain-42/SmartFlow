...
{
    public partial class ListQtyUsingMFr : Form
    {
        private static string connectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        public ListQtyUsingMFr()
        {
            InitializeComponent();
        }

        private void ListQtyUsingMFr_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailQtyUsingMfr detailQtyUsingMfr = new DetailQtyUsingMfr(dataInvoice, startDate, endDate);
                    detailQtyUsingMfr.MdiParent = Application.OpenForms["Dashboard"];
                    CommonFunction.DisposeOnClose(detailQtyUsingMfr);
                    detailQtyUsingMfr.Show();
                }
            }
        }
    }
