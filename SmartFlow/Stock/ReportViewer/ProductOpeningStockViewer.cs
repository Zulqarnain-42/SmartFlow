...
{
    public partial class ProductOpeningStockViewer : Form
    {
        public ProductOpeningStockViewer()
        {
            InitializeComponent();
        }

        private void ProductOpeningStockViewer_Load(object sender, EventArgs e)
        {
            try
            {
