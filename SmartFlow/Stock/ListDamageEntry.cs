...
{
    public partial class ListDamageEntry : Form
    {
        private static string connectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        public ListDamageEntry()
        {
            InitializeComponent();
        }

        private void ListDamageEntry_Load(object sender, EventArgs e)
        {
        ...
        private void searchbtn_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    this.Close();
                    DetailDamageEntry detailDamageEntry = new DetailDamageEntry(dataInvoice, startDate, endDate);
                    detailDamageEntry.MdiParent = Application.OpenForms["Dashboard"];
                    CommonFunction.DisposeOnClose(detailDamageEntry);
                    detailDamageEntry.Show();
                }
            }
        }
    }
